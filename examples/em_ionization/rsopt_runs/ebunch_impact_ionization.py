#!/usr/bin/env python
#
# Author: Nathan Cook, Chris Hall, A Diaw
#
#
"""
...
sys.path.insert(2, '/home/vagrant/jupyter/StaffScratch/abdoudiaw/rswarp/')
...
def ebunch_impact_ionization_func(x,y,z):
    #
    BEAM_CHARGE,BEAM_SIGMA_X,BEAM_SIGMA_Y = x,y,z
    #
    ...
    SHEET_DENSITY = 1e21 #number density in m^-3 - equivlent to 1e17 cm^-3:: 5e22 -5e23
    ...
    # Drive bunch: Q = 1.4 nC, rms z = 20 um, sig-x = 50 um, sig-y = 27 um
    #Beam parameters
    BEAM_CHARGE = BEAM_CHARGE #1.4e-9 #Beam charge in Coulombs :: 0.5 nC - 1.5 nC
    BEAM_ENERGY = 10. #10 GeV
    BEAM_LENGTH = 20e-6 #100 micron beam ~ 0.3 ps
    BEAM_DPP = 0.01 #1% dpp
    BEAM_SIGMA_X = BEAM_SIGMA_X #50e-6 #100 micron transverse beam sigma
    BEAM_SIGMA_Y = BEAM_SIGMA_Y #27e-6
    ...
    PRIMARY_WEIGHT = 5e2 #fix primary weight
    ...
    if z_field:
        ...
        #w3d.bounds[0] = 2 #lower x
        #w3d.bounds[1] = 2 #upper x
        #w3d.bounds[2] = 2 #lower y
        #w3d.bounds[3] = 2 #upper y
        ...
        #w3d.bounds[4] = 2 #lower z
        #w3d.bounds[5] = 2 #upper z
    ...
    c_x = xcen
    c_y = ycen
    c_z = zcen-BEAM_LENGTH #Z_MIN + 4.*BEAM_LENGTH #load beam at 4 sigma from left boundary
