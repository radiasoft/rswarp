...
class spherical():
    ...
    def __init__(self, radius = 1.0e-7, 
                ...
                output_to_file = False, file_name = 'emitted_particles.h5' ):
    ...
    def injector(self):
        ...
        area = self.radius ** 2. * 4. * np.pi / self.N_particles
...
class conical():
    ...
    def __init__(self, r_cone = 1.0e-7, z_cone = 1.0e-7,
        ...
        self.r_pts = - self.z_pts * r_cone / z_cone + r_cone
        self.x_offset = x_offset
        self.y_offset = y_offset
        self.voltage = voltage
        self.N_particles = N_particles
    ...
    def register(self, input_solver, input_beam, input_top):
        self.solver = input_solver
        self.beam = input_beam
        self.top = input_top
        self.beam.sw = 1.
    ...
    def injector(self):
        ...
        area = self.r_cone * np.pi * (self.r_cone + np.sqrt(self.z_cone ** 2. + self.r_cone ** 2.)) / self.N_particles
