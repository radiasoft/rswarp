...
def gather_lost_particles(top, comm_world):
    ...
    if comm_world.rank == 0:
        return xplost_all, yplost_all, zplost_all
    else:
...
def save_lost_particles(top, comm_world, fsave=None):
    ...
    xplost_all, yplost_all, zplost_all = gather_lost_particles(top, comm_world)
